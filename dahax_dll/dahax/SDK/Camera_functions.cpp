...
// (Net, NetServer, BlueprintCallable, BlueprintEvent)
// Parameters:
// const struct FRotator&                  SmoothControlRotation_0                                (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
...
void ACamera_C::Update_Light_Sphere_Scale()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Camera_C", "Update Light Sphere Scale");
