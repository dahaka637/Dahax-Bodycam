...
{
public:
	class ULiveLinkRetargetAsset*                 CurrentRetargetAsset;                              // 0x03B8(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected, TObjectPtr)
