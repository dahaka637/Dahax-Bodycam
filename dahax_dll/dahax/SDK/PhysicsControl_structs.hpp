...
public:
	...
	EMapConstraintsBehaviorType                   PhysicsAssetConditioningConstraintPosition;        // 0x02FD(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EMapConstraintsBehaviorType                   PhysicsAssetConditioningConstraintOrientation;     // 0x02FE(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	class UPhysicsControlAsset*                   PhysicsControlAsset;                               // 0x0310(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, TObjectPtr)
	...
	class USkeletalMesh*                          PhysicsAssetAuthoredSkeletalMesh;                  // 0x0620(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, TObjectPtr)
