...
void AGrenade_C::CanInterract(class AActor* Instigator_0, bool* Interract_)
{
	static class UFunction* Func = nullptr;
...
void AGrenade_C::CanPickup(class ACharacter* Player, bool* Pickup_)
{
	static class UFunction* Func = nullptr;
...
void AGrenade_C::Item_Focus(class AActor* Instigator_0)
{
	static class UFunction* Func = nullptr;
	...
	Params::Grenade_C_Item_Focus Parms{};
...
void AGrenade_C::Pickup(class AActor* Owner_0)
{
	static class UFunction* Func = nullptr;
...
void AGrenade_C::Pickup__Server_(class AActor* PlayerAttached_0)
{
	static class UFunction* Func = nullptr;
