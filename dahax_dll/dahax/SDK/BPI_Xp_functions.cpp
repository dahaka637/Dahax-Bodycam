...
void IBPI_Xp_C::GetCurrentRank(class FName* CurrentRank, int32* Rank_, int32* RankScore, int32* Connection_Streak)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BPI_Xp_C", "GetCurrentRank");
...
void IBPI_Xp_C::GetNewRank(class FText* Name_0, class UTexture2D** Image, int32* RankScore, int32* RankPosition, int32* RankDivision, double* PreviousRankProgress, double* RankProgress, bool* NewRank_, struct FSlateColor* Color, int32* Rank_Integer)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BPI_Xp_C", "GetNewRank");
...
void IBPI_Xp_C::Update_Death(int32 Death, bool Set)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BPI_Xp_C", "Update Death");
...
void IBPI_Xp_C::Update_Kill(const struct FSTR_KillInfo& KillInfo)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BPI_Xp_C", "Update Kill");
...
void IBPI_Xp_C::UpdateXp(int32 Xp)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BPI_Xp_C", "UpdateXp");
