...
public:
	...
	class UInterchangeFbxTranslatorSettings*      CacheFbxTranslatorSettings;                        // 0x0058(0x0008)(ZeroConstructor, Transient, DuplicateTransient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate, TObjectPtr)
...
public:
	...
	class UInterchangeUsdTranslatorSettings*      TranslatorSettings;                                // 0x0060(0x0008)(ZeroConstructor, Transient, DuplicateTransient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate, TObjectPtr)
