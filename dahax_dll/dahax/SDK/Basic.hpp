...
namespace Offsets
{
	constexpr int32 GObjects          = 0x09253270;
	constexpr int32 AppendString      = 0x01260A00;
	constexpr int32 GNames            = 0x09137CC8;
	constexpr int32 GWorld            = 0x093CFB50;
	constexpr int32 ProcessEvent      = 0x01488A40;
