...
struct FTransform IALS_Camera_BPI_C::BPI_Get_3P_PivotTarget()
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("ALS_Camera_BPI_C", "BPI_Get_3P_PivotTarget");
...
void IALS_Camera_BPI_C::BPI_Get_3P_TraceParams(struct FVector* TraceOrigin, double* TraceRadius, ETraceTypeQuery* TraceChannel)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("ALS_Camera_BPI_C", "BPI_Get_3P_TraceParams");
...
void IALS_Camera_BPI_C::BPI_Get_CameraParameters(double* TP_FOV, double* FP_FOV, bool* RightShoulder)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("ALS_Camera_BPI_C", "BPI_Get_CameraParameters");
...
struct FVector IALS_Camera_BPI_C::BPI_Get_FP_CameraTarget()
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("ALS_Camera_BPI_C", "BPI_Get_FP_CameraTarget");
