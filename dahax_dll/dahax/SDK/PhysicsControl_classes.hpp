...
public:
	...
	uint8                                         Pad_2A1[0x1FF];                                    // 0x02A1(0x01FF)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	class UPhysicsControlComponent*               ControlComponent;                                  // 0x02A8(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate, TObjectPtr)
	class UPhysicsControlInitializerComponent*    ControlInitializerComponent;                       // 0x02B0(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate, TObjectPtr)
