...
public:
	...
	struct FHitResult                             K2Node_Event_HitInfo;                              // 0x0078(0x0100)(ConstParm, IsPlainOldData, NoDestructor, ContainsInstancedReference)
};

// Function BP_Helmet.BP_Helmet_C.ReceivePointDamage
// 0x0178 (0x0178 - 0x0000)
struct BP_Helmet_C_ReceivePointDamage final
{
public:
