...
void ACameraControlTable_C::CanInterract(class AActor* Instigator_0, bool* Interract_)
{
...
void ACameraControlTable_C::CanPickup(class ACharacter* Player, bool* Pickup_)
{
	static class UFunction* Func = nullptr;
...
void ACameraControlTable_C::Item_Focus(class AActor* Instigator_0)
{
	static class UFunction* Func = nullptr;
	...
	Params::CameraControlTable_C_Item_Focus Parms{};
...
void ACameraControlTable_C::Pickup(class AActor* Owner_0)
{
	static class UFunction* Func = nullptr;
