...
void IBPI_Grenade_C::Blow_(bool* Blow__0)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BPI_Grenade_C", "Blow?");
...
void IBPI_Grenade_C::GrenadeActivation()
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BPI_Grenade_C", "GrenadeActivation");
...
void IBPI_Grenade_C::GrenadeExplosion()
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BPI_Grenade_C", "GrenadeExplosion");
