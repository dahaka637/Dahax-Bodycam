...
void UBP_MenuControllerComponent_C::AddInitiallyAddedIMCs()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_MenuControllerComponent_C", "AddInitiallyAddedIMCs");
...
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// const class FName                       MappingName                                            (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// const struct FGameplayTag&              KeyProfile                                             (BlueprintVisible, BlueprintReadOnly, Parm, NoDestructor, HasGetValueTypeHash)
