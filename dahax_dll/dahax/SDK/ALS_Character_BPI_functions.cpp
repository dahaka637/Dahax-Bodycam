...
void IALS_Character_BPI_C::ApplyPointDamage(double Damage, double RagdollForce, class FName BoneName, const struct FVector& Location, const struct FVector& ShotFromDirection, class AController* ControllerInstigator, bool DisableHeadShot)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("ALS_Character_BPI_C", "ApplyPointDamage");
...
void IALS_Character_BPI_C::BPI_Death()
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("ALS_Character_BPI_C", "BPI_Death");
...
void IALS_Character_BPI_C::BPI_Get_RotationMode(EALS_RotationMode* GetRotationMode)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("ALS_Character_BPI_C", "BPI_Get_RotationMode");

	Params::ALS_Character_BPI_C_BPI_Get_RotationMode Parms{};
...
void IALS_Character_BPI_C::BPI_PlayAnimMontage(class UAnimMontage* AnimMontage, double PlayRate)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("ALS_Character_BPI_C", "BPI_PlayAnimMontage");

	Params::ALS_Character_BPI_C_BPI_PlayAnimMontage Parms{};
...
// Function ALS_Character_BPI.ALS_Character_BPI_C.StopMontage (Replicated)
// (Public, BlueprintCallable, BlueprintEvent)

void IALS_Character_BPI_C::StopMontage__Replicated_()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("ALS_Character_BPI_C", "StopMontage (Replicated)");
