...
public:
	static class UClass* StaticClass()
	{
		STATIC_CLASS_IMPL("SteamCoreProSettings")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"SteamCoreProSettings")
	}
...
public:
	...
	TMulticastInlineDelegate<void(const struct FSetPersonaNameResponse& Data)> SetPersonaNameResponse; // 0x00D8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(const struct FJoinClanChatRoomCompletionResult& Data)> JoinClanChatRoomCompletionResult; // 0x00E8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(const struct FClanOfficerListResponse& Data)> ClanOfficerListResponse; // 0x00F8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(const struct FDownloadClanActivityCountsResult& Data)> DownloadClanActivityCountsResult; // 0x0108(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(const struct FEquippedProfileItemsChanged& Data)> EquippedProfileItemsChanged; // 0x0118(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
public:
	static class UClass* StaticClass()
	{
		STATIC_CLASS_IMPL("SteamCoreProFriendsAsyncActionSetPersonaName")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"SteamCoreProFriendsAsyncActionSetPersonaName")
	}
...
class USteamCoreProFindSession : public USteamCoreProAsyncAction
{
public:
