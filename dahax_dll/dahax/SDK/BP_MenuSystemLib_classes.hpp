...
public:
	...
	void GetControlsValues(class UObject* __WorldContext, bool* bInvertSticks, bool* bInvertXAxis, bool* bInvertYAxis, double* XAxisSensitivity, double* YAxisSensitivity, bool* VibrationEnabled, bool* AutoLean, double* CameraShakeAxisSensivity, bool* EnableVoiceChat, bool* BotsMethod, bool* LobbyAccessMethod);
	void RunHardwareBenchmark(class UObject* __WorldContext);

public:
	static class UClass* StaticClass()
	{
		BP_STATIC_CLASS_IMPL("BP_MenuSystemLib_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"BP_MenuSystemLib_C")
	}
